...
import org.onlineshoppingcart.entity.Order;
import org.onlineshoppingcart.entity.OrderDetail;
import org.onlineshoppingcart.entity.Product;
import org.onlineshoppingcart.model.CartInfo;
import org.onlineshoppingcart.model.CartLineInfo;
...
public class OrderDAOImpl implements OrderDAO {
    ...
    public List<OrderDetailInfo> listOrderDetailInfos(String orderId) {
        String sql = "Select new " + OrderDetailInfo.class.getName() //
                + "(d.id, d.product.code, d.product.name, d.product.memory, d.quanity,d.price,d.amount) "//
